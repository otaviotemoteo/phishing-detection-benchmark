...
PROFILE_GUIDANCE: dict[str, list[str]] = {
    ...
    PROFILE_MACOS_MPS: [
        ...
        "  - NumPy and scikit-learn run the same BLAS library here as on the",
        "    reference machine, OpenBLAS, but an arm64 build of it: different",
        "    kernels, different threading, different reduction order. The header",
        "    above prints what your install actually linked.",
        "",
